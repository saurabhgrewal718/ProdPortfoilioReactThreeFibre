    ...
    <directionalLight position={[-5, 5, 5]} castShadow shadow-mapSize={1024} /> */}
        ...
        <ScrollControls pages={10}>
          ...
          <Scroll html style={{ width: '100%' }}>
            ...
            <p style={{ color: '#cdcbca', position: 'absolute', top: `420vh`, left: '50%', fontSize: '20px', textAlign: 'center', transform: `translate(-50%,-50%)` }}>I have Been working for 5 years now and so far i have worked with the following companies, its been a wonderful journey so far :)</p>
